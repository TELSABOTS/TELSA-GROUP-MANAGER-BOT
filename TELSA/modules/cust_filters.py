...
from TELSA.modules.helper_funcs.misc import build_keyboard
...
__help__ = """
 - /filters:  CURRENT FILTERS IN THIS CHAT
*Admin only*

/filter <keyword> <reply message>: TO ADD FILTER
 /stop <filter keyword>: TO DELETE FILTER
"""
