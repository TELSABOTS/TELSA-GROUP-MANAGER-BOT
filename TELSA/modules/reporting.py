...
def report(bot: Bot, update: Update) -> str:
    ...
    if chat and message.reply_to_message and sql.chat_should_report(chat.id):
       ...
       # 
        ...
        message.reply_to_message.reply_text("{} DONE REPORTED THIS MSG TO ADMINS.".
...
def control_panel_user(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="⬅️BACK⬅️", callback_data="cntrl_panel_U(1)")]]
...
def buttons(bot: Bot, update):
    ...
    if splitter[1] == "kick":
        ...
        try:
            ...
            query.answer("✅MSG DELETED🗑")
            return ""
        except Exception as err:
            bot.sendMessage(text="Error: {}".format(err),
                                  chat_id=query.message.chat_id,
                                  parse_mode=ParseMode.HTML)
            query.answer("❎FAILED TO DELETE MSG❎")
